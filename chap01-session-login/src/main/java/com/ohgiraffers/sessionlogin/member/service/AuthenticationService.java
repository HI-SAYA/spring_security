...
@Slf4j // 롬복이 가지고 있음. logger 객체 따로 필드에 선언 안해도 이 클래스 안에서 로그라는 이름으로 로거라는 객체를 사용할 수 있다.
@Service
public class AuthenticationService implements UserDetailsService {  /* Authentication 입증 */
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        /* UserDetails 라는 인터페이스를 구현하는 구현체 => User() */
        /* UserDeatails를 구현한 User 객체에 id, pwd, 권한을 전달해서 객체를 생성하고 반환한다. */
